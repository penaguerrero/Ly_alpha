...
# Path to files
Bstarpath_v10andv2 = glob.glob('../Tlusty/solar/B*/')    # this is to get all the files with different metallicities
for Bstarpath in Bstarpath_v10andv2:
    ...
    for i in range(0, total_files):
        ...
        rebin_spec, rebin_cont = spectrum.rebin_arrays_for_desired_resolution(desired_delta_lambda, Lyalpha, spec_arr, cont_arr, guessed_rows=800)
