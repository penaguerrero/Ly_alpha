...
#pyplot.ylim(-15, 225)
pyplot.text(6.1, 5, 'stellar component')   
pyplot.text(6.1, 150, 'nebular component')   
pyplot.text(7.6, 165, 'total=nebular+stellar')  
...
#pyplot.ylim(-15, 170)
pyplot.text(6.1, 5, 'stellar component')   
pyplot.text(6.1, 60, 'nebular component')   
pyplot.text(6.7, 120, 'total=nebular+stellar')   
...
for i in range(0, len(constant_tot)):
    pyplot.figure(1)
    curve_i, = pyplot.plot(fixed_ste[i][0], fixed_ste[i][1], colors[i])
    curve_i.set_linestyle('--')
    curve, = pyplot.plot(fixed_neb[i][0], fixed_neb[i][1], colors[i])
    curves_cont.append(curve)
    curve, = pyplot.plot(fixed_tot[i][0], fixed_tot[i][1], colors[i])
    curve.set_linestyle(':')
    curves_inst.append(curve_i)
    pyplot.figure(2)
    curve_c, = pyplot.plot(constant_ste[i][0], constant_ste[i][1], colors[i])
    curve_c.set_linestyle('--')
    curve, = pyplot.plot(constant_neb[i][0], constant_neb[i][1], colors[i])
    curves_cont.append(curve)
