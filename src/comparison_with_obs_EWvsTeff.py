...
plot_name = 'comparison_with_obs_EWvsTeff2.eps'

# There are 3 types of data for this plot: CMFGEN, TLUSTY, and OBSERVATIONS
data_type = ["TW(CMFGEN)", "TW(TLUSTY)", "SC70", "SP74"]
...
c1 = pyplot.plot(teff_cmfgen, ew_cmfgen, 'k^')
c2 = pyplot.plot(teff_tlusty, ew_tlusty, 'ko')
c3 = pyplot.plot(teff_sc70o, ew_sc70on, 'rs')
c4 = pyplot.plot(teff_sp74o, ew_sp74on, 'cs')
...
leg = pyplot.figure(1).legend(curves, data_type, bbox_to_anchor=(0.87, 0.35), labelspacing=0.2)
